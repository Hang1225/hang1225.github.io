...
function loadInstagramFeed() {
    ...
    // 4. Display them in the feed
    
    console.log('Instagram feed loading...');
    
    // For now, we'll just show a message
    const instagramPlaceholder = document.querySelector('.instagram-placeholder');
    if (instagramPlaceholder) {
        // This would be replaced with actual Instagram posts
        console.log('Instagram integration ready for setup');
    }
}
...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.section-title, .menu-item, .about-content, .contact-content');
